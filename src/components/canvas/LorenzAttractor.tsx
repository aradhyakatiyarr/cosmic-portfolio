...
export const LorenzAttractor: React.FC<LorenzAttractorProps> = ({ isActive: _isActive, scrollProgress }) => {
  ...
  return (
    <group position={[-8.0, 3.0 + (scrollProgress - 5) * 2.2, -32.0]}>
      ...
      >
        <div className="hidden lg:block px-3 py-1 rounded bg-space-deep/90 border border-blue-500/30 backdrop-blur-md text-[9px] font-mono text-blue-400 tracking-wider uppercase shadow-[0_0_10px_rgba(59,130,246,0.15)] whitespace-nowrap animate-pulse">
