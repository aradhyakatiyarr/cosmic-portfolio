...
export const DecisionTree: React.FC<DecisionTreeProps> = ({ isActive: _isActive, scrollProgress }) => {
  ...
  return (
    ...
    >
      ...
      >
        <div className="hidden lg:block px-3 py-1 rounded bg-space-deep/90 border border-yellow-500/30 backdrop-blur-md text-[9px] font-mono text-yellow-400 tracking-wider uppercase shadow-[0_0_10px_rgba(251,191,36,0.15)] whitespace-nowrap animate-pulse">
