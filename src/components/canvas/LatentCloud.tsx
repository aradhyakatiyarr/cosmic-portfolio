...
export const LatentCloud: React.FC<LatentCloudProps> = ({ scrollProgress }) => {
  ...
  return (
    <group position={[0, (scrollProgress - 0) * 2.2, 0]}>
      ...
      >
        <div className="px-3 py-1 rounded bg-space-deep/90 border border-purple-500/30 backdrop-blur-md text-[9px] font-mono text-purple-400 tracking-wider uppercase shadow-[0_0_10px_rgba(139,92,246,0.15)] whitespace-nowrap animate-pulse">
          LATENT SPACE DATA CLOUD
        </div>
      </Html>
    </group>
  );
